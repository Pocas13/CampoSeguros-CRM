-- Idempotent repair for the InsureFlow Neon schema.
...
DO $$ BEGIN
  ALTER TABLE "InsurerContact"
    ADD CONSTRAINT "InsurerContact_insurerId_fkey"
...
DO $$ BEGIN
  ALTER TABLE "Policy"
    ADD CONSTRAINT "Policy_insurerId_fkey"
    FOREIGN KEY ("insurerId") REFERENCES "Insurer"("id")
...
WHERE NOT EXISTS (
  SELECT 1 FROM "Insurer" i
  WHERE lower(COALESCE(i."commercialName", i."name")) = lower(v.commercial)
);
